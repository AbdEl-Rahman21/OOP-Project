...
public class General_Trips extends Trips{
    Scanner scanner = new Scanner(System.in);
    int choice;
    public General_Trips(String destination , int numberOfSeats , String startDate , String endDate , int pricePerSeat , String trip_ID) {
