...
public class couple_trip extends Trips{
    Scanner scanner = new Scanner(System.in);
    int choice;
    public couple_trip(String destination , int numberOfSeats , String startDate , String endDate , int pricePerSeat , String trip_ID) {
    ...
    {
        if (booked_Seats==2&&booked_Seats<=numberOfSeats)
        {
